...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-surface-bg bg-mesh flex items-center justify-center px-6 relative overflow-hidden">
      {/* Visual Orbs */}
      <div className="absolute top-1/4 -left-20 w-96 h-96 bg-primary-600/10 rounded-full blur-[100px] animate-float" />
      <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-accent-blue/10 rounded-full blur-[100px] animate-float" style={{ animationDelay: '2s' }} />
      ...
      <div className="w-full max-w-[440px] relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 text-sm font-medium">Access your dashboard and manage bookings.</p>
        </div>

        <div className="glass-morphism rounded-[32px] responsive-card">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-sm font-bold text-slate-300 mb-2.5 ml-1">Email address</label>
            ...
            <div>
              <label className="block text-sm font-bold text-slate-300 mb-2.5 ml-1">Password</label>
              <div className="relative">
                <input
                  id="login-password"
